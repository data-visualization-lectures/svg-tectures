...
i18next.init({
	...
	resources: {
		ja: {
			translation: {
				appTitle: 'SVG テクスチャエディタ',
				appSubtitle: 'Textures.jsを用いたリアルタイムテクスチャ編集ツール',
				controlsTitle: 'コントロール',
				textureTypeLabel: 'テクスチャの種類',
				linesOption: 'Lines（線）',
				diagonalStripeOption: 'Diagonal Stripe（斜線）',
				horizontalStripeOption: 'Horizontal Stripe（横線）',
				verticalStripeOption: 'Vertical Stripe（縦線）',
				circlesOption: 'Circles（円）',
				dotsOption: 'Dots（ドット円）',
				crossesOption: 'Crosses（交差）',
				squaresOption: 'Squares（正方形）',
				hexagonsOption: 'Hexagons（六角形）',
				wovenOption: 'Woven（織り模様）',
				wavesOption: 'Waves（波線）',
				capsOption: 'Caps（キャップ）',
				nylonOption: 'Nylon（ナイロン）',
				noneOption: 'None（なし）',
				fgColorLabel: '前景色',
				bgColorLabel: '背景色',
				densityLabel: 'テクスチャの密度',
				thicknessLabel: 'テクスチャの太さ',
				svgSampleLabel: 'SVGサンプル',
				barChartOption: '棒グラフ',
				pieChartOption: '円グラフ',
				networkOption: 'ネットワークダイアグラム',
				gridOption: 'グリッド',
				applyBtnLabel: '適用',
				infoText: 'テクスチャの種類、色、サンプルを選択して「適用」ボタンをクリックすると、右側のプレビューにテクスチャが適用されます。',
				previewTitle: 'プレビュー',
				codeTitle: 'JavaScriptコード',
				copyBtnLabel: 'コピー',
				copySuccessText: '✓ クリップボードにコピーしました',
				noTextureComment: '// テクスチャなし',
				generatedCodeComment: '// SVG Texture Editor で生成されたコード',
				texturesLibComment: '// Textures.js: https://riccardoscalco.it/textures/',
				textureConfigComment: '// テクスチャの設定',
				applyTextureComment: '// SVGに適用',
				fillElementsComment: '// 塗りつぶし要素にテクスチャを適用',
				copyErrorMsg: 'コピーに失敗しました:'
			}
		},
		en: {
			translation: {
				appTitle: 'SVG Texture Editor',
				appSubtitle: 'Real-time texture editing tool using Textures.js',
				controlsTitle: 'Controls',
				textureTypeLabel: 'Texture Type',
				linesOption: 'Lines',
				diagonalStripeOption: 'Diagonal Stripe',
				horizontalStripeOption: 'Horizontal Stripe',
				verticalStripeOption: 'Vertical Stripe',
				circlesOption: 'Circles',
				dotsOption: 'Dots',
				crossesOption: 'Crosses',
				squaresOption: 'Squares',
				hexagonsOption: 'Hexagons',
				wovenOption: 'Woven',
				wavesOption: 'Waves',
				capsOption: 'Caps',
				nylonOption: 'Nylon',
				...
				densityLabel: 'Texture Density',
				thicknessLabel: 'Texture Thickness',
				svgSampleLabel: 'SVG Sample',
				barChartOption: 'Bar Chart',
				pieChartOption: 'Pie Chart',
				networkOption: 'Network Diagram',
				gridOption: 'Grid',
				applyBtnLabel: 'Apply',
				infoText: 'Select texture type, color, and sample, then click the "Apply" button to apply texture to the preview on the right.',
				previewTitle: 'Preview',
				codeTitle: 'JavaScript Code',
				copyBtnLabel: 'Copy',
				copySuccessText: '✓ Copied to clipboard',
				noTextureComment: '// No texture',
				generatedCodeComment: '// Code generated by SVG Texture Editor',
				texturesLibComment: '// Textures.js: https://riccardoscalco.it/textures/',
				textureConfigComment: '// Texture configuration',
				applyTextureComment: '// Apply to SVG',
				fillElementsComment: '// Apply texture to fill elements',
				copyErrorMsg: 'Failed to copy:'
			}
		}
	}
});
...
function initializeUI() {
	...
	const textElements = {
		...
		'textureTypeLabel': 'textureTypeLabel',
		'fgColorLabel': 'fgColorLabel',
		'bgColorLabel': 'bgColorLabel',
		'densityLabel': 'densityLabel',
		'thicknessLabel': 'thicknessLabel',
		'svgSampleLabel': 'svgSampleLabel',
		...
		'diagonalStripeOption': 'diagonalStripeOption',
		'horizontalStripeOption': 'horizontalStripeOption',
		'verticalStripeOption': 'verticalStripeOption',
		'circlesOption': 'circlesOption',
		'dotsOption': 'dotsOption',
		'crossesOption': 'crossesOption',
		'squaresOption': 'squaresOption',
		'hexagonsOption': 'hexagonsOption',
		'wovenOption': 'wovenOption',
		'wavesOption': 'wavesOption',
		'capsOption': 'capsOption',
		'nylonOption': 'nylonOption',
...
class TextureEditor {
    ...
    generateCodeSnippet() {
        ...
        if (this.currentTexture === 'noop') {
            textureCode = i18next.t('noTextureComment');
    ...
    .strokeWidth(${baseStroke * thicknessMultiplier});`;
        ...
        const code = `${i18next.t('generatedCodeComment')}
${i18next.t('texturesLibComment')}

${i18next.t('textureConfigComment')}
${textureCode}

${i18next.t('applyTextureComment')}
svg.call(tx);

${i18next.t('fillElementsComment')}
svg.selectAll('rect, circle, path')
    ...
    copyCodeToClipboard() {
        ...
        navigator.clipboard.writeText(code).then(() => {
            ...
            console.error(i18next.t('copyErrorMsg'), err);
        });
    }
}
