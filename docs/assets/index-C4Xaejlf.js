(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();const f="https://vebhoeiltxspsurqoxvl.supabase.co",k="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZlYmhvZWlsdHhzcHN1cnFveHZsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzAyMjI2MTIsImV4cCI6MjA0NTc5ODYxMn0.sV-Xf6wP_m46D_q-XN0oZfK9NogDqD9xV5sS-n6J8c4",v="https://api.dataviz.jp",d="https://auth.dataviz.jp",b="sb-dataviz-auth-token",y=60*60*24*365,u=(()=>{const i=window.location.hostname;return i==="localhost"||i==="127.0.0.1"||i.match(/^(\d{1,3}\.){3}\d{1,3}$/)?null:".dataviz.jp"})(),C={getItem:i=>{const e=document.cookie.split(";").map(t=>t.trim()).filter(Boolean);for(const t of e){const[s,...r]=t.split("=");if(s===i){const o=decodeURIComponent(r.join("="));try{return JSON.parse(o)}catch{}try{const n=(o.startsWith("base64-")?o.slice(7):o).replace(/-/g,"+").replace(/_/g,"/");return JSON.parse(atob(n))}catch{return null}}}return null},setItem:(i,e)=>{let t;try{t=btoa(e)}catch{return}let s=`${i}=${t}; Max-Age=${y}; Path=/; SameSite=None; Secure`;u&&(s+=`; Domain=${u}`),document.cookie=s},removeItem:i=>{let e=`${i}=; Max-Age=0; Path=/; SameSite=None; Secure`;u&&(e+=`; Domain=${u}`),document.cookie=e}},h=window.supabase?window.supabase.createClient(f,k,{auth:{storage:C,storageKey:b,persistSession:!0,autoRefreshToken:!0,detectSessionInUrl:!0}}):null;class w{constructor(){this.host=document.createElement("div"),this.host.id="dataviz-global-header-host",this.shadow=this.host.attachShadow({mode:"open"}),this.state={isLoading:!0,user:null}}mount(){const e=document.getElementById("dataviz-global-header-host");e&&e.remove(),document.body.prepend(this.host),this.render()}update(e){this.state={...this.state,...e},this.render()}getStyles(){return`
    ...
    `}render(){const{isLoading:e,user:t}=this.state,s=`${d}/auth/sign-up?redirect_to=${encodeURIComponent(window.location.href)}`;let r="";if(e)r='<span class="dv-loading">Loading...</span>';else if(t){const a=t.email||"User";r=`
        <div class="dv-user-info">
          <span class="dv-user-email" title="${a}">${a}</span>
        </div>
        <button class="dv-btn" id="dv-logout-btn">Log out</button>
      `}else r=`
        <span style="font-size:12px; color:#888;">Not logged in</span>
        <a href="${s}" class="dv-btn dv-btn-primary">Log in</a>
    ...
    .background('${r}')
    .size(${c*e})
    .strokeWidth(${m*t});`:o=`const tx = textures.paths()
    .d('${l}')
    .stroke('${s}')
    .background('${r}')
    .size(${c*e})
